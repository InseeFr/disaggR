...
#' @description 
#'
#' The twoStepsBenchmark() function and its wrappers allow you to disaggregate a low frequency time serie using time series of higher frequency, using the French National Accounts methodology.
...
#' See "Methodology of quarterly national accounts", Insee Méthodes N°126, by Passeron et al. (2012, ISBN:978-2-11-068613-8).
#'
#' @import stats
#' @keywords internal
"_PACKAGE"
