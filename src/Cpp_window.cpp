...
NumericVector Cpp_window_NumericVector(NumericVector const& x,double const& tseps,NumericVector const& start,NumericVector const& end) {
  R_len_t lengthy;
...
NumericMatrix Cpp_window_NumericMatrix(NumericMatrix const& x,double const& tseps,NumericVector const& start,NumericVector const& end) {
  R_len_t lengthy;
  unsigned int casenumber;
  int i0=0,i1=0,i1minusi0=0,max1=0,max2=0;
  double ystart,yend,xfreq;
...
SEXP Cpp_window(SEXP const& x,double const& tseps,NumericVector const& start,NumericVector const& end) {
  ...
  else res = Cpp_window_NumericVector(x,tseps,start,end);
  return res;
}